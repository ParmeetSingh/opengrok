...
public class JFlexTokenizerTest {
    ...
    private void testOffsetAttribute(Class<? extends JFlexTokenizer> klass)
        ...
        if(klass.getName().equals(PlainFullTokenizer.class.getName())){
        	testPlainTokenizer();
        }
    }

    private void testPlainTokenizer() throws Exception {
    	String inputText = "alpha` beta(";
        String[] expTokens = {"alpha","`","beta","("};
        testOffsetAttribute(PlainFullTokenizer.class, inputText, expTokens);
        
        inputText = "alpha{ beta}";
        String[] expTokens2 = {"alpha","{","beta","}"};
        testOffsetAttribute(PlainFullTokenizer.class, inputText, expTokens2);
        
        inputText = "alpha/ beta,";
        String[] expTokens3 = {"alpha","/","beta",","};
        testOffsetAttribute(PlainFullTokenizer.class, inputText, expTokens3);
        
        inputText = "alpha; beta!";
        String[] expTokens4 = {"alpha",";","beta","!"};
        testOffsetAttribute(PlainFullTokenizer.class, inputText, expTokens4);
