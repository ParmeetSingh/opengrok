...
public class JSONSearchServlet extends HttpServlet {
    ...
    private static final String PARAM_EXACT = "exactText";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        String exactText = req.getParameter(PARAM_EXACT);
        ...
        if (exactText != null) {
            exactText = URLDecoder.decode(exactText);
            engine.setExactText(exactText);
            valid = true;
            result.put(PARAM_EXACT, exactText);
        }
